...
スクリーニングロジック: オリンピック卓球 金メダル 3個以上獲得
"""
import argparse
import json
import sys
...
from src.optimizations.table_tennis_top10 import get_top10, get_screening_logic


def main():
    parser = argparse.ArgumentParser(
        description="卓球 Top 10（金メダル3個以上）"
    )
    ...
    if args.json:
        ...
        print(f"【卓球 Top 10】金メダル {args.min}個以上{gender_str}\n")
        print("スクリーニング: オリンピック卓球 金メダル 3個以上 | ソート: 金メダル数降順\n")
